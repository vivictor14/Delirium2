...
updateLaby(OldLaby, L, X, Y, Pos, Size) :- updateLaby(L, X, Y, Pos, Size, OldLaby, Laby, 0, 0), nb_setval(labyrinthe, Laby).

updateLaby(L, X, Y, Pos, Size, OldLaby, [[E]], Xe, Ye) :- coordLastElement(OldLaby, X1, Y1), Xe >= X1, Ye >= Y1, posLastElement(L, Pos1), posToCoord(X, Y, Pos, Size, Pos1, X2, Y2), Xe = X2, Ye = Y2, elemAtPos(L, Pos1, E).
updateLaby(L, X, Y, Pos, Size, OldLaby, [[E]], Xe, Ye) :- posLastElement(L, Pos1), posToCoord(X, Y, Pos, Size, Pos1, X1, Y1), Xe >= X1, Ye >= Y1, coordLastElement(OldLaby, X2, Y2), Xe = X2, Ye = Y2, elemAtCoord(OldLaby, X2, Y2, E).
updateLaby(L, X, Y, Pos, Size, OldLaby, [[-1]], Xe, Ye) :- coordLastElement(OldLaby, X1, Y1), Xe >= X1, Ye >= Y1, posLastElement(L, Pos1), posToCoord(X, Y, Pos, Size, Pos1, X2, Y2), Xe >= X2, Ye >= Y2.
updateLaby(L, X, Y, Pos, Size, OldLaby, [[E]|R2], Xe, Ye) :- coordLastElement(OldLaby, X1, _), Xe >= X1, posLastElement(L, Pos1), posToCoord(X, Y, Pos, Size, Pos1, X2, Y2), Xe = X2, Ye =< Y2, posToCoord(X, Y, Pos, Size, 0, _, Y3), Ye >= Y3, Pos2 is (Pos + (Xe - X) + Size * (Ye - Y)), elemAtPos(L, Pos2, E), Ye1 is Ye + 1, updateLaby(L, X, Y, Pos, Size, OldLaby, R2, 0, Ye1).
updateLaby(L, X, Y, Pos, Size, OldLaby, [[E]|R2], Xe, Ye) :- posLastElement(L, Pos1), posToCoord(X, Y, Pos, Size, Pos1, X1, _), Xe >= X1, coordLastElement(OldLaby, X2, Y2), Xe = X2, Ye =< Y2, elemAtCoord(OldLaby, Xe, Ye, E), Ye1 is Ye + 1, updateLaby(L, X, Y, Pos, Size, OldLaby, R2, 0, Ye1).
updateLaby(L, X, Y, Pos, Size, OldLaby, [[-1]|R2], Xe, Ye) :- coordLastElement(OldLaby, X1, _), Xe >= X1, posLastElement(L, Pos1), posToCoord(X, Y, Pos, Size, Pos1, X2, _), Xe >= X2, Ye1 is Ye + 1, updateLaby(L, X, Y, Pos, Size, OldLaby, R2, 0, Ye1).
updateLaby(L, X, Y, Pos, Size, OldLaby, [[E|R1]|R2], Xe, Ye) :- posToCoord(X, Y, Pos, Size, 0, X1, Y1), Xe >= X1, Ye >= Y1, posLastElement(L, Pos1), posToCoord(X, Y, Pos, Size, Pos1, X2, Y2), Xe =< X2, Ye =< Y2, Pos2 is (Pos + (Xe - X) + Size * (Ye - Y)), elemAtPos(L, Pos2, E), Xe1 is Xe + 1, updateLaby(L, X, Y, Pos, Size, OldLaby, [R1|R2], Xe1, Ye).
updateLaby(L, X, Y, Pos, Size, OldLaby, [[E|R1]|R2], Xe, Ye) :- coordLastElement(OldLaby, X1, Y1), Xe =< X1, Ye =< Y1, elemAtCoord(OldLaby, Xe, Ye, E), Xe1 is Xe + 1, updateLaby(L, X, Y, Pos, Size, OldLaby, [R1|R2], Xe1, Ye).
